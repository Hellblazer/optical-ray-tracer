...
final public class ControlManager implements ProgramControl {
	...
	public ControlManager(final JRadioButton b, OpticalRayTracer p,
		...
		ArrayList<ArrayList<JRadioButton>> radioArrayList = new ArrayList<>(Arrays.asList(parent.typeRadioButtonList,parent.leftCurvatureRadioButtonList,parent.rightCurvatureRadioButtonList));
		...
		radio.addActionListener(new ActionListener() {
			@Override
			public void actionPerformed(ActionEvent e) {
				radioButtonList[radioButtonIndex] = radioButtonArray.indexOf(radio);
				updateAllControls();
			}
		});
	}
	...
	public String getValue() {
		...
		//parent.p("controlmanager get value: tag: " + tag + ", value:" + result);
		return result;
	}
