...
final public class OpticalRayTracer {
	...
	private JRadioButton leftSphButton;
	private JRadioButton leftParButton;
	private JRadioButton leftHypButton;
	protected final ButtonGroup leftCurvButtonGroup = new ButtonGroup();
	private JRadioButton rightSphButton;
	private JRadioButton rightParButton;
	private JRadioButton rightHypButton;
	...
	public OpticalRayTracer(String[] args) {
		...
		JRadioButton[] crbl = new JRadioButton[] { leftSphButton,
				leftParButton, leftHypButton };
		leftCurvatureRadioButtonList = new ArrayList<>(Arrays.asList(crbl));
		JRadioButton[] crbr = new JRadioButton[] { rightSphButton,
				rightParButton, rightHypButton };
		rightCurvatureRadioButtonList = new ArrayList<>(Arrays.asList(crbr));
	...
	void setupOpticalControlFields() {
		ControlManager[] array = new ControlManager[] {
				...
				new ControlManager(leftSphButton, this, "leftCurvature"),
				new ControlManager(leftHypButton, this, "leftCurvature"),
				new ControlManager(leftParButton, this, "leftCurvature"),

				new ControlManager(rightSphButton, this, "rightCurvature"),
				new ControlManager(rightHypButton, this, "rightCurvature"),
				new ControlManager(rightParButton, this, "rightCurvature"),
	...
	void clearSelection() {
		...
		this.internalThicknessTextField.setEnabled(false);
	}
	...
	void enableComponentControls(boolean enabled) {
		...
		if (selectedComponent != null) {
			...
			rightSphereRadiusTextField.setEnabled(state);
			this.rightSphButton.setEnabled(state);
			this.rightParButton.setEnabled(state);
			this.rightHypButton.setEnabled(state);
			boolean rhs = rightHypButton.isSelected();
			boolean lhs = leftHypButton.isSelected();
	...
	private void initialize() {
		...
		tabbedPane
				.addTab("Design",
						...
						designPane, "Design lenses and optical layout");
		...
		lensDesignControlPane.setLayout(new BorderLayout(0, 0));

		JPanel westSubPanel = new JPanel();
		lensDesignControlPane.add(westSubPanel, BorderLayout.WEST);
		westSubPanel.setLayout(new MigLayout("", "[111px][grow][][]",
				"[23px][][][]"));
		...
		westSubPanel.add(nameTextField, "cell 1 0");
		nameTextField.setColumns(10);

		JLabel lblPosition = new JLabel("Position");
		westSubPanel.add(lblPosition, "cell 2 0 2 1,alignx center");
		...
		westSubPanel.add(lblX, "cell 2 1,alignx center");

		xPosTextField = new JTextField();
		westSubPanel.add(xPosTextField, "cell 3 1");
		...
		westSubPanel.add(lblThickness, "cell 0 2");

		thicknessTextField = new JTextField();
		thicknessTextField
				.setToolTipText("<html>Lens thickness apart from curvature<br/>(red if value conflict exists)");
		...
		westSubPanel.add(lblY, "cell 2 2,alignx center");

		yPosTextField = new JTextField();
		westSubPanel.add(yPosTextField, "cell 3 2");
		...
		westSubPanel.add(lblEffectiveThickness, "cell 0 3,alignx trailing");

		internalThicknessTextField = new JTextField();
		internalThicknessTextField.setEditable(false);
		internalThicknessTextField
				.setToolTipText("<html>Lens thickness after crossover prevention<br/>(red if value conflict exists)");
		...
		lensDesignControlPane.add(lensDesignControlBox, BorderLayout.CENTER);
		...
		JLabel lblSelectCurvature = new JLabel("Surface Curvature");
		lensDesignControlBox.add(lblSelectCurvature,
				"cell 2 0 3 0,alignx center");
		
		JLabel lblCurvatureFactor = new JLabel("Hyp Curvature");
		lblCurvatureFactor.setHorizontalAlignment(SwingConstants.CENTER);
		lensDesignControlBox.add(lblCurvatureFactor, "cell 5 0,alignx center");

		JLabel lblLeft = new JLabel("Left");
		lensDesignControlBox.add(lblLeft, "cell 0 1,alignx trailing");
		...
		leftSphButton = new JRadioButton("Sph");
		leftCurvButtonGroup.add(leftSphButton);
		leftSphButton.setToolTipText("Choose spherical curvature");
		lensDesignControlBox.add(leftSphButton, "cell 2 1");

		leftParButton = new JRadioButton("Par");
		leftCurvButtonGroup.add(leftParButton);
		leftParButton.setToolTipText("Choose parabolic curvature");
		lensDesignControlBox.add(leftParButton, "cell 3 1");

		leftHypButton = new JRadioButton("Hyp");
		leftCurvButtonGroup.add(leftHypButton);
		leftHypButton.setToolTipText("Choose hyperbolic curvature");
		lensDesignControlBox.add(leftHypButton, "cell 4 1");
		
		leftZTextField = new JTextField();
		leftZTextField.setToolTipText("Hyperboloid lens curvature factor");
		leftZTextField.setHorizontalAlignment(SwingConstants.RIGHT);
		lensDesignControlBox.add(leftZTextField, "cell 5 1");
		leftZTextField.setColumns(10);

		JLabel lblRight = new JLabel("Right");
		lensDesignControlBox.add(lblRight, "cell 0 2,alignx trailing");
		...
		rightSphButton = new JRadioButton("Sph");
		rightCurvButtonGroup.add(rightSphButton);
		rightSphButton.setToolTipText("Choose spherical curvature");
		lensDesignControlBox.add(rightSphButton, "cell 2 2");

		rightParButton = new JRadioButton("Par");
		rightCurvButtonGroup.add(rightParButton);
		rightParButton.setToolTipText("Choose parabolic curvature");
		lensDesignControlBox.add(rightParButton,
				"cell 3 2,alignx right,aligny top");

		rightHypButton = new JRadioButton("Hyp");
		rightHypButton.setToolTipText("Choose hyperbolic curvature");
		rightCurvButtonGroup.add(rightHypButton);
		lensDesignControlBox.add(rightHypButton, "cell 4 2");
		
		rightZTextField = new JTextField();
		rightZTextField.setToolTipText("Hyperboloid lens curvature factor");
		rightZTextField.setHorizontalAlignment(SwingConstants.RIGHT);
		lensDesignControlBox.add(rightZTextField, "cell 5 2");
		rightZTextField.setColumns(10);

		JPanel lensOptionsControlBox = new JPanel();
		lensDesignControlPane.add(lensOptionsControlBox, BorderLayout.SOUTH);
		...
		lensOptionsControlBox.add(activeCheckBox, "cell 7 0");

		refractRadioButton = new JRadioButton("Refract");
		refractRadioButton.setToolTipText("Refracts all rays that intersect");
		refractRadioButton.setName("");
		typeButtonGroup.add(refractRadioButton);
		lensOptionsControlBox.add(refractRadioButton, "flowx,cell 8 0");

		reflectRadioButton = new JRadioButton("Reflect");
		reflectRadioButton.setToolTipText("Reflects all rays that intersect");
		reflectRadioButton.setName("");
		typeButtonGroup.add(reflectRadioButton);
		lensOptionsControlBox.add(reflectRadioButton, "cell 8 0");

		absorbRadioButton = new JRadioButton("Absorb");
		absorbRadioButton.setToolTipText("Absorbs all rays that intersect ");
		absorbRadioButton.setName("");
		typeButtonGroup.add(absorbRadioButton);
		lensOptionsControlBox.add(absorbRadioButton, "cell 8 0");
